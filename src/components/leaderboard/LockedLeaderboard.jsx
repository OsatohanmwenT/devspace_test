...
function SkeletonRow({ width }) {
  return (
    <div className={ROW_GRID}>
      ...
      <span className="w-12 h-2.5 rounded-full bg-[#2e2e2e] [[data-theme=light]_&]:bg-[#ececea] justify-self-end" />
    </div>
  )
}
...
export function LeagueJoinPrompt({ onStartPractice }) {
  return (
    <div className="mt-1 flex w-full items-center gap-4 border-t border-[#404040] [[data-theme=light]_&]:border-[#ebe9e4] pt-5 text-left max-[680px]:flex-col max-[680px]:gap-3 max-[680px]:text-center">
      ...
      <div className="grid min-w-0 flex-1 gap-1">
        ...
        <span className="text-[14px] leading-[1.5] text-[#9a9a9d] [[data-theme=light]_&]:text-[#686968]">
          Earn a Devy Coin to join. A clean first-try answer, a finished lesson, or a practice round all count.
        </span>
      </div>
      <ActionButton
        variant="primary"
