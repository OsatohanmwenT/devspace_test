...
// delta is null for the first day of the season, when there is no previous day to
  ...
  return (
    <Tag
      ...
      className={`${isCurrentUser
        ? `${ROW_GRID} my-1 rounded-2xl border border-[#8bb5f5] bg-[#2a293c] [[data-theme=light]_&]:border-[#b9d4f7] [[data-theme=light]_&]:bg-[#e9f2ff]`
        : `${ROW_GRID} rounded-xl border border-transparent transition-colors duration-150 hover:bg-[#262626] [[data-theme=light]_&]:hover:bg-[#f3f1ec]`
      } ${interactive ? 'w-full text-left cursor-pointer' : ''}`}
    >
