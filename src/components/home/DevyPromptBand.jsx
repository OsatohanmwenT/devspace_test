...
export function DevyPromptBand({ isComposing, accent, onComposeStart, onComposeEnd, onOpen }) {
  return (
    <div className="home-prompt-band relative mx-auto w-full max-w-[640px]" data-compose={isComposing} style={{ "--prompt-accent": accent }}>
