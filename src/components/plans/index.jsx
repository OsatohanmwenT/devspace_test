...
function CloseButton({ onClick }) {
  return (
    <button type="button" onClick={onClick} className="absolute top-5 right-5 grid size-11 place-items-center rounded-xl border border-[#57575d] bg-transparent text-[#d4d4d9] hover:bg-white/10 focus-visible:outline-3 focus-visible:outline-offset-3 focus-visible:outline-[#8d89ff] [[data-theme=light]_&]:border-[#d4d4d4] [[data-theme=light]_&]:text-[#525252] [[data-theme=light]_&]:hover:bg-black/5" aria-label="Close Premium plans">
...
export default function PlansView({ progress, onActivate, onCancel, highlightPerk, onBack }) {
  ...
  if (progress.isPremium) {
    ...
    return (
      <section className="relative grid min-h-screen place-items-center overflow-hidden bg-[#111113] px-5 py-20 text-[#f4f4f6] [[data-theme=light]_&]:bg-white [[data-theme=light]_&]:text-[#181818]" aria-label="Premium">
        ...
        <div className="grid w-full max-w-[580px] gap-6 rounded-[24px] border border-[#3a3a3e] bg-[#1d1d20] p-7 text-center [[data-theme=light]_&]:border-[#e1e1e1] [[data-theme=light]_&]:bg-white [[data-theme=light]_&]:shadow-[0_2px_6px_rgba(20,20,20,0.06)]">
          <span className="justify-self-center rounded-full bg-[#6f66ec]/20 px-3 py-1 text-xs font-semibold text-[#b8b3ff] [[data-theme=light]_&]:bg-[#6f66ec]/12 [[data-theme=light]_&]:text-[#513deb]">Premium active</span>
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#111113] px-5 py-16 text-[#f4f4f6] max-[680px]:px-4 max-[680px]:py-20 [[data-theme=light]_&]:bg-white [[data-theme=light]_&]:text-[#181818]" aria-label="Premium plans">
      <CloseButton onClick={onBack} />
      <div className="mx-auto grid w-full max-w-[1160px] gap-8">
        <header className="mx-auto grid max-w-[630px] gap-3 text-center">
          <span className="text-[11px] font-bold tracking-[.13em] text-[#8d89ff] uppercase [[data-theme=light]_&]:text-[#513deb]">Devspace Premium</span>
        ...
        <div className="mx-auto grid w-full max-w-[760px] gap-5">
          <div className="flex items-center justify-between gap-4 max-[560px]:flex-col max-[560px]:items-stretch">
            <h2 className="m-0 text-[15px] font-semibold text-[#f7f7f8] [[data-theme=light]_&]:text-[#181818]">How you want to pay</h2>
          ...
          <section className="grid gap-3 rounded-2xl border border-[#3a3a3e] bg-[#1d1d20] p-5 [[data-theme=light]_&]:border-[#d4d4d4] [[data-theme=light]_&]:bg-white" aria-labelledby="premium-perks-title">
            <h2 id="premium-perks-title" className="m-0 text-sm font-semibold text-[#f7f7f8] [[data-theme=light]_&]:text-[#181818]">Every plan includes</h2>
            <PerkList perks={PREMIUM_PERKS} highlightPerk={highlightPerk} />
          </section>
          ...
          {!confirming ? (
            ...
            <section className="grid justify-items-center gap-3 rounded-2xl border border-[#6f66ec] bg-[#6f66ec]/10 p-5 text-center [[data-theme=light]_&]:bg-[#f1efff]" aria-live="polite">
