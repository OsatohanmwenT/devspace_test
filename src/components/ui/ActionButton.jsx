const variants = {
  ...
  neutral: 'rounded-[14px] border border-[#525252] [[data-theme=light]_&]:border-[#b8b2a8] bg-[#262626] [[data-theme=light]_&]:bg-white text-[#f4f4f2] [[data-theme=light]_&]:text-[#202020] shadow-[0_4px_0_#171717] [[data-theme=light]_&]:shadow-[0_4px_0_#d8d4cd] hover:brightness-110 hover:-translate-y-0.5 active:translate-y-1 active:shadow-none',
}
