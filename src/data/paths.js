    ...
    cards: [
      {
        ...
        summary: 'Learn to read a real dataset — what rows, columns, and variable types actually represent.',
        reason: 'Every later spreadsheet, query, and chart is built from rows, columns, and variables — this is the vocabulary underneath all of it.',
        goals: ['Read a dataset as rows and columns', 'Tell categorical and numerical variables apart'],
        state: 'current',
        progress: '0%',
        progressValue: 0,
        image: '/assets/exploring-data-visually.png',
        lessons: [
          { id: 'data-analysis-basics', title: 'Datasets and Variable Types', state: 'current', description: 'Learn what a dataset actually represents, using Northstar Store’s real order data.' },
        ],
      },
      {
        ...
        summary: 'A neat-looking dataset can still produce a bad answer — learn to check before you trust it.',
        reason: 'These foundations make every later spreadsheet, query, and chart easier to trust and act on.',
        goals: ['Spot common data-quality problems', 'Follow the analysis workflow', 'Handle people’s data responsibly'],
        state: 'locked',
        progress: '0%',
        progressValue: 0,
        image: '/assets/exploring-data-visually.png',
        lessons: [
          { id: 'data-quality-workflow', title: 'Quality and the Analysis Workflow', state: 'locked', description: 'Learn how analysts check data before trusting it, then follow it through to a communicated result.' },
        ],
      },
      upcomingRegion('data-analyst-spreadsheets', 'Region 3', 'Spreadsheet Fundamentals', 'Organise, filter, and summarise data with confidence in a spreadsheet.', 'Build a summary table', '/assets/programming-with-variables.png'),
      upcomingRegion('data-analyst-sql', 'Region 4', 'SQL Fundamentals', 'Pull the exact rows you need straight from a database.', 'Write a first query', '/assets/thinking-in-code.png'),
      upcomingRegion('data-analyst-cleaning-viz', 'Region 5', 'Data Cleaning & Visualization', 'Spot messy data and present findings so people understand them fast.', 'Clean a dataset', '/assets/scientific-thinking.png'),
      upcomingRegion('data-analyst-statistics', 'Region 6', 'Statistics Basics', 'Use averages, distributions, and significance to avoid fooling yourself.', 'Test an assumption', '/assets/probability-and-chance.png'),
      upcomingRegion('data-analyst-capstone', 'Region 7', 'Insights Capstone', 'Take a real dataset from question to a decision-ready report.', 'Deliver an insight report', '/assets/exploring-data-visually.png'),
    ],
  },
  {
    id: 'video-editor',
