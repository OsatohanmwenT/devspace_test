...
export const rivals = [
  ...
  { id: 'nuriye-s', name: 'Nuriye Sarıca', role: 'Product Designer', tag: 'PRO', pace: 88, consistency: 0.9 },
  ...
  { id: 'narduccio-v', name: 'Narduccio van der Veekens', role: 'UX/UI Designer', tag: 'PRO', pace: 71, consistency: 0.86 },
  ...
  { id: 'priya-s', name: 'Priya Sharma', role: 'AI Engineer path', tag: 'PRO', pace: 61, consistency: 0.81 },
  ...
  { id: 'kazuhiro-c', name: 'Kazuhiro Chō', role: 'Student', tag: null, pace: 41, consistency: 0.58 },
  { id: 'sridevi-r', name: 'Sridevi Rao', role: 'Data Scientist path', tag: null, pace: 38, consistency: 0.55 },
  ...
  { id: 'daniel-o', name: 'Daniel Okonkwo', role: 'Student', tag: null, pace: 35, consistency: 0.52 },
  { id: 'elena-v', name: 'Elena Vasquez', role: 'UX/UI Designer', tag: null, pace: 59, consistency: 0.67 },
  { id: 'hiroshi-t', name: 'Hiroshi Tanaka', role: 'Backend Developer path', tag: 'PRO', pace: 91, consistency: 0.89 },
  ...
  { id: 'yuki-s', name: 'Yuki Sato', role: 'Product Designer', tag: null, pace: 55, consistency: 0.64 },
  ...
  { id: 'mei-w', name: 'Mei Wong', role: 'Machine Learning Engineer path', tag: 'PRO', pace: 87, consistency: 0.85 },
  { id: 'rasmus-j', name: 'Rasmus Jensen', role: 'Data Scientist path', tag: null, pace: 51, consistency: 0.62 },
  { id: 'chidi-e', name: 'Chidi Eze', role: 'Student', tag: null, pace: 29, consistency: 0.45 },
  ...
  { id: 'linnea-o', name: 'Linnéa Öberg', role: 'Data Scientist path', tag: 'PRO', pace: 83, consistency: 0.87 },
